...
var clockLayout = new Layout({
  type: "v", c: [
    { type: "txt", font: "35%", halign: -1, fillx: 1, pad: 8, label: "00:00", id: "time" },
    {
      type: "h", fillx: 1, c: [
    ...
    {
      type: "h", valign: 1, c: [
        { type: "img", filly: 1, pad: 10, id: "weatherIcon", src: sunIcon },
        { type: "txt", font: "10%", id: "temp", label: "00 °F" }
      ]
    },
    {
      type: "h", valign: 1, c: [
        { type: "img", filly: 1, pad: 10, id: "homeIcon", src: houseIcon },
...
function draw() {
  ...
  if (weatherJson && weatherJson.weather) {
    ...
    clockLayout.temp.label = "N/A";
    clockLayout.temp2.label = "N/A";
